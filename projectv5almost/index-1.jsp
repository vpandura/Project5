                ...
                <div class="container">
                    <div class="row">
                        <div class="navbar-header">
                            ...
                            <a href="index.jsp"> <img src="images/logo.svg" width="50px" alt="TicketEasy-logo" style=" padding-top:8px;" class="navbar-left"></a>
                        ...
                        <div style="display:inline-block; float:right; margin-left:2%;">

                        <li class="dropdown btn btn-warning navbar-btn" style="font-family:'Myriad-Pro'; margin-top:15px;">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"style="color:rgba(255,255,255,1.00); text-decoration:none;"><span class="glyphicon glyphicon-plane" style="color:rgba(255,255,255,1.00); text-decoration:none;"></span> &nbsp;Domestic &nbsp;<span class="caret" style="color:rgba(255,255,255,1.00); text-decoration:none;"></span></a>

                            <ul class="dropdown-menu">
                                <li><a href="AA.jsp">American Airlines</a></li>
                                <li><a href="DA.jsp">Delta Airways</a></li>
                                <li><a href="SA.jsp">Spirit Airways</a></li>
                                <li><a href="FA.jsp">Frontier Airways</a></li>
                            </ul>
                        </li>
                        </div>
                        ...
                        <li class="dropdown btn btn-success navbar-btn" style="font-family:'Myriad-Pro'; margin-top:15px;">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"style="color:rgba(255,255,255,1.00); text-decoration:none;"><span class="glyphicon glyphicon-plane" style="color:rgba(255,255,255,1.00); text-decoration:none;"></span> &nbsp;International &nbsp;<span class="caret" style="color:rgba(255,255,255,1.00); text-decoration:none;"></span></a>

                            <ul class="dropdown-menu">
                                <li><a href="AI.jsp">Air India</a></li>
                                <li><a href="EA.jsp">Emirates</a></li>
                                <li><a href="VA.jsp">Virgin- Atlantic Airlines</a></li>
                                <li><a href="BA.jsp">British Airways</a></li>
                            </ul>
                        </li>
                        </div>
                    </div>
