...
<html lang="en">
    ...
    <body>
        ...
        <!-- Sign in Block -->
        <div class="container" id="sign-in-container" style="margin-top:10%">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-offset-4 sign-in-container-bottom">
                    <legend><br>
                    </legend>
                    <p class="text-center">New to TicketEasy?</p>
                    <a class="btn btn-danger col-md-10 col-md-offset-1 create-account-button" href="Register.jsp">Create an Account</a> <br>
                </div>
            </div>
        </div>
