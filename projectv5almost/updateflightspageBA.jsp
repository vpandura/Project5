        ...
        <div class="container" id="sign-in-container" style="margin-top:5%">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 sign-in-container-top">
                    <h1 class="text-center">Update Flight for British Airways</h1>
                    ...
                    <form action="updateflights.jsp" method="post">
                        ...
                        <div class="form-group col-md-10 col-md-offset-1" >
                            ...
                            <input type="text"  id="emailaddress" class="form-control" name="Airlines" value="British Airways" readonly>
                        </div>
                        <div class="form-group col-md-10 col-md-offset-1" >
