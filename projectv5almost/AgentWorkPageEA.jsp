...
<html lang="en">
    ...
    <header style="margin-bottom:0px; position:absolute; top:0; left:0; width:100%;">
        <div style="background-repeat:no-repeat; background-size:auto; height:750px;">
        	<img src="images/EM.png" class="center-block img-responsive">
        </div>
    </header>
    ...
    <div class="container" style="margin-top:25%; border-top: 1px rgba(0,0,0,0.32) solid; padding:2%;">
    	<div class="row">
        	<div class="col-lg-4">
            	<a href="addflightspageEA.jsp"><p class="text-center bg-success" style="padding:2%;">Add new Flight details</p></a>
            </div>
            <div class="col-lg-4">
            	<a href="deleteflightspage.jsp"><p class="text-center bg-danger" style="padding:2%;">Delete Flight details</p></a>
            </div>
            <div class="col-lg-4">
            	<a href="updateflightspageEA.jsp"><p class="text-center bg-warning" style="padding:2%;">Update Flight details</p></a>
            </div>
        </div>
